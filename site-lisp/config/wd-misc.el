...
;;      (zh-font (font-spec :family "WenQuanYi Zen Hei" :size 14)))
;;  (set-default-font "Monaco:pixelsize=10:foundry=unknown")
...
;; ;; 字体设置
;; (qiang-set-font
;;  '("Monaco" "DejaVu Sans Mono" "Monospace" "Courier New") ":pixelsize=15"
;;  '("WenQuanYi Zen Hei" "Microsoft Yahei" "文泉驿等宽微米黑" "黑体" "新宋体" "宋体"))

;; (add-hook 'after-make-frame-functions
;;   (lambda(arg)
;;     (if  (&gt;= (length (frame-list)) 1)
;;           (set-fontset-font  "fontset-startup" 'chinese-gbk (font-spec :family "WenQuanYi Zen Hei" :size 15) nil 'prepend)
;;       )
;;     ) t
;; ))
